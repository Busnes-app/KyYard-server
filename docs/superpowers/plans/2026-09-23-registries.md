...
- Host normalisation: lowercase; `docker.io`, `index.docker.io`, `registry-1.docker.io` and empty → `docker.io`; grammar `^[a-z0-9][a-z0-9.-]{0,252}(:[0-9]{1,5})?$`. Name 1..64 display characters (`protocol.CleanText`).
