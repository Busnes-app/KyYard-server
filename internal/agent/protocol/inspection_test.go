...
func TestInspectionUnsupportedVocabulary(t *testing.T) {
	...
	if len(UnsupportedCodes) != 37 || len(UnsupportedCodes) > MaxUnsupported || UnsupportedCodes[0] != "mount_type" || UnsupportedCodes[28] != "image_config" || UnsupportedCodes[33] != "k8s_namespace" || UnsupportedCodes[34] != "k8s_volume_shared" || UnsupportedCodes[36] != "k8s_service_renamed" {
