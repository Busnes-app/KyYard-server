...
func (s *Server) RunLocalDocker(ctx context.Context) error {
	...
	return client.Run(ctx, id, client.Options{Version: "builtin", CommandDir: dir, Snapshot: engine.Snapshot, Metrics: engine.Stats, Operate: engine.Operate, Logs: engine.Logs, Inspect: engine.InspectContainer, Exec: func(ctx context.Context, spec protocol.ExecSpec) (client.ExecSession, error) {
