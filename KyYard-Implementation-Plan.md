...
2. Use module `github.com/Busness-app/kyyard-server`, display name `KyYard`, image `ghcr.io/busnes-app/kyyard`, container/service `kyyard`, and a consistently named product binary.
