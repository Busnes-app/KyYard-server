...
- `scripts/spikes/websocket-proxy/run.sh`: disposable compatibility spike behind `docs/agent-protocol.md` section 2 (own Go module; needs Docker); prints `RESULT <proxy> PASS` for Caddy and nginx
