...
- Repository: `Busness-app/kyyard-server`; Go module: `github.com/Busness-app/kyyard-server`; binary: `kyyard-server`; image: `ghcr.io/busnes-app/kyyard`; Compose service/container: `kyyard`; display and default recovery service name: `KyYard`. Container persistence is `/data`, including `/data/backups`.
