...
export const MIGRATION_ERRORS: Record<string, string> = {
  ...
  application_name_taken: 'Applications already hold the destination name or project and every suffix up to (9). Rename, remove or discard an old destination first.',
